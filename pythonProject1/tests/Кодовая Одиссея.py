...
with webdriver.Chrome() as browser:
    ...
    '''Проходимся по списку чек-боксов, получаем значения атрибута 'value' для чек-боксов 
    и сравниваем значения со значениями списка numbers'''
    for check in check_boxes:
        value = int(check.get_attribute('value'))
        if value in numbers:
            check.click()
